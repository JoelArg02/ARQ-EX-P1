            ...
            <div class="checkout-form">
                ...
                <form action="${pageContext.request.contextPath}/checkout" method="post" id="checkoutForm">
                    <div class="form-group">
                        ...
                        <% if (isAdmin) { %>
                            <!-- Admin puede elegir cualquier cédula -->
                        ...
                        <% } else { %>
                            <!-- Usuario normal solo puede comprar para sí mismo -->
                            <input type="text" id="cedula" name="cedula" 
                                   value="<%= cedulaUsuario %>" readonly
                                   style="background-color: #f1f5f9; cursor: not-allowed;">
                            <input type="hidden" name="cedulaCliente" value="<%= cedulaUsuario %>">
                            <small>📋 Comprando para: <strong><%= nombreCliente %></strong></small>
                        <% } %>
                    </div>
