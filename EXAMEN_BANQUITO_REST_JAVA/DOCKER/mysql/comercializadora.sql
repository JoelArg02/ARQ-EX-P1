...
-- ====================================================================
-- TABLA: Usuario
-- Descripci�n: Usuarios del sistema de la comercializadora
-- ====================================================================
...
-- ====================================================================
-- �NDICES PARA OPTIMIZACI�N DE CONSULTAS
-- ====================================================================
...
-- ====================================================================
INSERT INTO Producto (codigo, nombre, precio, stock, imagen) VALUES
('REF001', 'Refrigeradora LG 14 pies', 899.00, 15, 'data:image/jpeg;base64,REF001_BASE64'),
('LAV001', 'Lavadora Samsung 20 lb', 749.00, 20, 'data:image/jpeg;base64,LAV001_BASE64'),
('COC001', 'Cocina Indurama 6 quemadores', 489.00, 12, 'data:image/jpeg;base64,COC001_BASE64'),
('MIC001', 'Microondas Panasonic 1.2 cu ft', 159.00, 30, 'data:image/jpeg;base64,MIC001_BASE64'),
('LIC001', 'Licuadora Oster 10 velocidades', 89.00, 40, 'data:image/jpeg;base64,LIC001_BASE64'),
('TV001', 'Smart TV LG 55 pulgadas', 1299.00, 8, 'data:image/jpeg;base64,TV001_BASE64'),
('TV002', 'Smart TV Samsung 43 pulgadas', 849.00, 10, 'data:image/jpeg;base64,TV002_BASE64'),
('ASP001', 'Aspiradora Electrolux 1800W', 249.00, 18, 'data:image/jpeg;base64,ASP001_BASE64'),
('PLAN001', 'Plancha a vapor Black+Decker', 45.00, 50, 'data:image/jpeg;base64,PLAN001_BASE64'),
('VEN001', 'Ventilador de Torre Samurai', 79.00, 25, 'data:image/jpeg;base64,VEN001_BASE64');
...
-- Usuarios CLIENTE: su c�dula / abcd1234
-- ====================================================================
