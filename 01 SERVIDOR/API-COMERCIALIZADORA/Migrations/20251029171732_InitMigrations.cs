        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Facturas_FormasPago_FormaPagoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallesFactura_Electrodomesticos_ElectrodomesticoId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pago inmediato con descuento del 33% sobre el precio de venta.", "Efectivo" },
                    { 2, "Compra financiada validada mediante el servicio web del Banco BanQuito.", "Crédito Directo" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Contrasena", "Nombre" },
                values: new object[] { 123, "MONSTER9", "MONSTER" });

            migrationBuilder.CreateIndex(
                name: "IX_DetallesFactura_ElectrodomesticoId",
