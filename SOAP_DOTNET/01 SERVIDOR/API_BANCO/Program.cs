...
app.MapGet("/", async context =>
{
    ...
    html.AppendLine("    <title>API Banco - Servicios SOAP</title>");
    ...
    html.AppendLine("        h1 { color: #2c3e50; border-bottom: 3px solid #e74c3c; padding-bottom: 10px; }");
    html.AppendLine("        .service-list { list-style: none; padding: 0; }");
    html.AppendLine("        .service-item { background: #ecf0f1; margin: 10px 0; padding: 15px; border-radius: 5px; border-left: 4px solid #e74c3c; }");
    html.AppendLine("        .service-item h3 { margin: 0 0 10px 0; color: #2c3e50; }");
    html.AppendLine("        .service-item a { color: #e74c3c; text-decoration: none; margin-right: 15px; }");
    html.AppendLine("        .service-item a:hover { text-decoration: underline; }");
    html.AppendLine("        .info { background: #ffeaa7; padding: 15px; border-radius: 5px; margin-top: 20px; border-left: 4px solid #fdcb6e; }");
    html.AppendLine("    </style>");
    html.AppendLine("</head>");
...
Console.WriteLine("=============================================");
Console.WriteLine("API BANCO - Servicios SOAP");
Console.WriteLine("=============================================");
foreach (var service in serviceList)
{
    Console.WriteLine($"Servicio: http://localhost:5001{service}");
    Console.WriteLine($"WSDL: http://localhost:5001{service}?wsdl");
}
Console.WriteLine("=============================================");
Console.WriteLine("Página de inicio: http://localhost:5001/");
Console.WriteLine("=============================================");
