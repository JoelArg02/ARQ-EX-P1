...
<body>
    ...
    <script>
        ...
        function mostrarAmortizacion(idFactura) {
            ...
            // Obtener la factura del servidor REST de Comercializadora (DigitalOcean)
            // LOCAL: fetch('http://localhost:8081/Ex_Comercializadora_RESTJava-1.0-SNAPSHOT/api/facturas/' + idFactura)
