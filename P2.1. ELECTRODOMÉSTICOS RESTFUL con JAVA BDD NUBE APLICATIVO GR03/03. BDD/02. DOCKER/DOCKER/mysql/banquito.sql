...
-- Insertar 50+ Movimientos (depósitos y retiros en los últimos 3 meses)
-- Movimientos para Juan Carlos Pérez (1750123456) - Cuenta 10001234
INSERT INTO MOVIMIENTO (NUM_CUENTA, TIPO, VALOR, FECHA) VALUES
('10001234', 'DEP', 1500.00, '2025-11-10'),
('10001234', 'DEP', 2000.00, '2025-11-05'),
('10001234', 'RET', 500.00, '2025-11-01'),
...
('10001234', 'DEP', 1900.00, '2025-09-25'),
('10001234', 'DEP', 2100.00, '2025-09-18'),
('10001234', 'RET', 600.00, '2025-09-10'),

-- Movimientos para María Elena García (1750234567) - Cuenta 10002345
('10002345', 'DEP', 2500.00, '2025-11-12'),
('10002345', 'DEP', 3000.00, '2025-11-08'),
('10002345', 'RET', 800.00, '2025-11-02'),
...
('10002345', 'DEP', 2900.00, '2025-09-28'),
('10002345', 'DEP', 3100.00, '2025-09-20'),
('10002345', 'RET', 900.00, '2025-09-15'),

-- Movimientos para Pedro Antonio Morales (1750345678) - Cuenta 10003456
('10003456', 'DEP', 3500.00, '2025-11-14'),
('10003456', 'DEP', 4000.00, '2025-11-09'),
('10003456', 'RET', 1000.00, '2025-11-03'),
...
('10003456', 'DEP', 3900.00, '2025-09-26'),
('10003456', 'DEP', 4100.00, '2025-09-19'),
('10003456', 'RET', 1100.00, '2025-09-12'),

-- Movimientos para Ana Sofía Ramírez (1750456789) - Cuenta 10004567
('10004567', 'DEP', 1200.00, '2025-11-11'),
('10004567', 'DEP', 1500.00, '2025-11-06'),
('10004567', 'RET', 300.00, '2025-10-31'),
...
('10004567', 'DEP', 1300.00, '2025-09-24'),
('10004567', 'DEP', 1550.00, '2025-09-17'),
('10004567', 'RET', 350.00, '2025-09-11'),

-- Movimientos para Luis Fernando Castro (1750567890) - Cuenta 10005678
('10005678', 'DEP', 1800.00, '2025-11-13'),
('10005678', 'DEP', 2200.00, '2025-11-07'),
('10005678', 'RET', 600.00, '2025-11-04'),
...
('10005678', 'DEP', 2100.00, '2025-09-23'),
('10005678', 'DEP', 2300.00, '2025-09-16'),
('10005678', 'RET', 700.00, '2025-09-09');

-- Insertar algunos créditos de ejemplo (algunos activos, otros cancelados)
